...
namespace UI {
    public class Menu : Window {
        ...
        protected void OnHelpClick(object obj, System.EventArgs args) {
           OpenHTML("help.html");
        }
        ...
        protected void OpenHTML(String relPath) {
            System.Threading.Tasks.Task.Run(() => System.Diagnostics.Process.Start(relPath));
        }
